...
export default class TodoList extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      array: [TodoList.createItem('Completed tas'), TodoList.createItem('Editing task'), TodoList.createItem('Active task'), TodoList.createItem('My Task'), TodoList.createItem('My Task')],
      filter: 'all',
      term: '',
    };
  }
